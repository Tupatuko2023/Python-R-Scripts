...
This task produces _aggregate-only_ reporting artifacts (tables + text snippets + figure callouts) suitable for manuscript/dissertation insertion.
...
1. **Results snippet (paste-ready)** (EN)
...
1. **Sensitivity snippet (MICE covariates-only)** (EN)
...
1. **Reviewer defense micro-bullets**
