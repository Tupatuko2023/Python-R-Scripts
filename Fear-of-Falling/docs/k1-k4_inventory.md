...
| Script                        | Role                                | Input                           | Output                                     | Dependencies                | Run Command                                          |
| ----------------------------- | ----------------------------------- | ------------------------------- | ------------------------------------------ | --------------------------- | ---------------------------------------------------- |
| K2.KAAOS-Z_Score_C_Pivot_2R.R | Transpose z-score results           | Unknown CSV                     | tables/K2\_...\_Transposed.csv             | dplyr, tidyr, readr, tibble | `Rscript R-scripts/K2/K2.KAAOS-Z_Score_C_Pivot_2R.R` |
