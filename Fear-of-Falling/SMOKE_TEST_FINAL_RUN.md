...
**Date:** 2025-12-26 16:14:06.351517
**Scripts tested:** 15
**Passed:** 10 ✓
**Failed:** 5 ✗
...
Calls: source -> withVisible -> eval -> eval -> load_raw_data
Execution halted
```
...
- **K1** (exit 1): Error in load_raw_data("KaatumisenPelko.csv") :
  Raw data file not found. Tried:
  - /project/data/raw/KaatumisenPelko.csv
  - /project/dataset/KaatumisenPelko.csv
