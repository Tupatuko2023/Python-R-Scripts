#!/usr/bin/env Rscript
# ==============================================================================
# K15 - modified 3-item physical frailty proxy (motor-oriented) derivation
# File tag: K15.R
...
plot_frailty_cat3_by_FOF <- ggplot(
  ...
  labs(
    x = "Modified 3-item physical frailty proxy (motor-oriented)",
    fill = "FOF-status",
...
# ==============================================================================
# Tämä skripti rakentaa eksplisiittisesti nimetyn "modified 3-item physical frailty proxy (motor-oriented)" -muuttujan.
