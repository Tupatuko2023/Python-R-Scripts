...
manifest_path <- file.path(outputs_dir, "manifest.csv")
...
# TÄHÄN väliin: mapataan sarakkeet analyysin käyttämiin nimiin
raw_data <- raw_data %>%
  dplyr::mutate(
    Composite_Z0 = ToimintaKykySummary0,
    Delta_Composite_Z = ToimintaKykySummary2 - ToimintaKykySummary0,
    ...
    Age = age,
    Sex = sex
    # BMI = BMI  # jos datassa on jo BMI-niminen sarake, tätä ei tarvitse muuttaa
  )
