...
legend_lines <- c(
  ...
  "and BMI data. The LONG mixed-effects analysis included eligible repeated",
  "locomotor-capacity observations meeting the model-frame requirements.",
  "",
  "The WIDE branch includes 230 participants. The LONG branch includes 400",
  "unique participants and 630 repeated observations. FOF group counts are",
