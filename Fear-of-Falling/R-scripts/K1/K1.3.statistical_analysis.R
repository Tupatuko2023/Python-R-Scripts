# KAAOS 1.3: R Script for Statistical Analysis & Group Comparisons of KaatumisenPelko Data
# [K1.3.statistical_analysis.R]

# "Performs detailed statistical analyses on KaatumisenPelko data: computes summary stats 
#  (mean, SD, CI) and executes paired & between-group t-tests"
...
# anova_results <- aov(Z_score ~ kaatumisenpelkoOn * Timepoint, data = df_long)
