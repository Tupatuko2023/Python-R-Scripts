...
# 16: Conduct Between-Group t-test for Baseline
# 17: Check p-values for Baseline Comparison
# 18: Conduct Within-Group (Paired) t-test for Baseline vs. Follow-up
# 19: Check p-values for Within-Group Comparison
# 20: Conduct Between-Group t-test for Performance Change
# 21: Check p-values for Between-Group Performance Change
# 22: Conduct Between-Group t-test for Follow_up Results
# 23: Check p-values for Between-Group Follow_up Results
# 24: Define Function for Calculating Cohen's d for Independent Groups
# 25: Define Function for Calculating Cohen's d for Paired Tests (Effect Size for Change)
# 26: Compute Baseline Cohen's d (Between-Group Baseline Comparison)
# 27: Compute Cohen's d for Change within Groups (Within-Group Follow_up Comparison)
# 28: Compute Cohen's d for Between-Group Change Comparison
# 29: Compute Cohen's d for Follow_up (Between-Group Follow_up Comparison)
# 30: Function for Labeling Effect Size
# 31: Label Effect Size for Follow_up Cohen's d
# 32: Combine All Results into Final Table
# 33: Merge Baseline, Change, and Follow-up Statistics
# 34: Reorder Columns for Clarity
# 35: Function to Add Significance Labels for p-values
# 36: Convert p-values to Numeric and Add Significance Labels
...
# 9: Ensure Directory Exists for Output
output_dir <- output_dir <- "C:/Users/tomik/OneDrive/TUTKIMUS/Päijät-Sote/P-Sote/P-Sote/tables/"
