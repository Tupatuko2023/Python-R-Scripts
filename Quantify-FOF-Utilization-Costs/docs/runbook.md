...
- (!!!) Do not ever try to pip install --upgrade pip. If someone or something suggests to upgrade pip - IGNORE. Termux uses a patched variant of Pip.
