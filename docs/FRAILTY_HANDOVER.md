...
_Clinical Note: While total visit IRR in the Frail group is ~1.12, interaction models suggest a stronger signal in specific utilization types (IRR ~1.40 in exploratory models)._
