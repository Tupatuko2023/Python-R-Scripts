...
3) `curl -H "Authorization: token ***" https://api.github.com/repos/ORG/REPO/actions/runs?per_page=1` (expect 200/403).
...
- Offline run attempt: `bash scripts/diag_network_github.sh` from PowerShell.
