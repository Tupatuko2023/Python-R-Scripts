...
- Expected: Unchanged (but verify type, might remain numeric if implementation allows, otherwise char). _Decision: For consistency, output columns should always be coerced to character if they are targeted for suppression._
