...
- 2026-09-25T13:55:31+03:00 Ownerin PR #165:ssä tekemä merge ja tämän lifecycle-toimeksiannon täsmennys muodostavat bootstrapin ihmishyväksynnän. PR #165 on MERGED; merge-commit `eefe8b5f6d30b298d0dd58dc3a2b6ff1c8f634ef` oli tarkistettaessa `origin/main`-haaran HEAD. Agentti valmisti saman tehtävän teknisen `03-review → 04-done`-siirron erilliseen lifecycle-PR:ään. Owner arvioi ja mergeää tämän PR:n erikseen; FIRA1-vaihe ei kuulu sulkuun.
- 2026-09-25T13:57:41+03:00 Lifecycle-ehdokkaan rajaus tarkistettu: vain kolme governance-ohjetta ja tämän saman taskin siirto, vanha polku poistuu. `git diff --cached --check` ja `bash tools/run-gates.sh --mode pre-push --smoke` läpäisivät (exit 0); handoverin SHA-256 täsmää hyväksyttyyn arvoon. CI tarkistetaan erillisen PR:n avaamisen jälkeen.
