...
1. **Read**: Read the _current_ file to grab the correct text for the sections listed above (especially the Replication and Stratified tables from the bottom).
